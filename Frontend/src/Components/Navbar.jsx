...
function Navbar({size}) {
  ...
  return (
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 font-sans dark:bg-slate-800 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
      ...
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="text-2xl md:text-4xl font-bold cursor-pointer">SoleMakers</a>
          </div>
